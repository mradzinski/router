...
val Element.addNotReplace: Boolean? get() = getAnnotation(RouterPath::class.java)?.addNotReplace

val Element.addToBackstack: Boolean? get() = getAnnotation(RouterPath::class.java)?.addToBackStack
